    ...
    <div className="m-4">
      <div className="mt-4 flex justify-between items-center">
        ...
        <div className="flex justify-center items-center gap-4">
          ...
          <div className="py-[0.4rem] h-fit px-[1rem] bg-primary-first hover:bg-primary-second hover:text-primary-first text-primary-second justify-center rounded-md text-sm  items-center cursor-pointer border-primary-second border-solid border-[1px]">
            See All
          </div>
        </div>
      </div>
