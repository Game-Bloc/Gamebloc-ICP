        ...
        <section className="flex">
          ...
          <div className="flex flex-col w-full">
            <div className="m-4 mt-24  ">
              <div className="h-full bg-primary-first">
                {/* <div
                  onClick={() => navigate(-1)}
                  ...
                  <div className=" flex flex-col w-fit justify-center items-center md:items-start md:justify-start  mt-8 bg-[#030C15] p-4 rounded-[1.6rem]">
                    <div className="flex ">
                      ...
                      <div className="flex ml-[3rem] flex-col">
                        <h2 className="text-white text-bold text-[1.5rem]">
                          {username}
                        </h2>
                    ...
                    <div className="mt-[.5rem] gap-4 flex flex-col md:flex-row ">
                      <div className="flex flex-col justify-start">
                        <p className="text-[#E0DFBA] text-base text-bold">
                          Principal I.D{" "}
                        </p>
                        <div className=" border-solid border-[#634E6D] mt-[.5rem] flex border rounded-md">
                          <Copy textToCopy={principalID} />
                          <h2 className="text-white p-[.5rem] ml-4 text-bold text-[1rem] w-[15rem] md:w-[10rem] whitespace-nowrap overflow-hidden text-ellipsis">
                            {principal}
                          </h2>
                        </div>
                      </div>
                      <div className="flex flex-col justify-start">
                        ...
                        <div className=" border-solid border-[#634E6D] mt-[.5rem] flex border rounded-md">
                          ...
                          <h2 className="text-white p-[.5rem] ml-4 text-bold text-[1rem] w-[15rem] md:w-[10rem] whitespace-nowrap overflow-hidden text-ellipsis">
                            GFHnfhctUYGFYVteyutyu76534FGHJGCJVJHssh4HJYCHGYTDY
                          </h2>
                        </div>
                      </div>
                    </div>
