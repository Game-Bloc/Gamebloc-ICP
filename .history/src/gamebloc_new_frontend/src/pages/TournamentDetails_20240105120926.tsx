                ...
                <div className=" w-full lg:w-[50%] mt-4 sm:mt-8 lg:mx-4 flex flex-col">
                  ...
                  <div className="border-solid border mt-8  border-[#2E3438] rounded-[0.625rem]">
                    ...
                    <div className="p-4 flex flex-col">
                      ...
                      <div className="flex flex-wrap w-full mt-[6px]">
                        <div className="flex justify-between items-center rounded-[9999px] pt-[0.1rem] px-[.75rem] pb-[0.1rem] sm:px-[1.2rem] sm:pb-[0.4rem] sm:pt-[.3rem]  bg-[#FEE4E2] border-none">
                          <img src={`img1.svg`} className="m-0" alt="" />
                          <p className=" text-[#D92D20] text-[0.5rem] sm:text-[0.8rem] cursor-pointer font-medium">
                            Action
                          </p>
                        </div>
