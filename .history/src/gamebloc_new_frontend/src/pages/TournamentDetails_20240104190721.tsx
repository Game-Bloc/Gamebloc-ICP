                  ...
                  <div className="flex w-full justify-center items-center">
                    <div className="relative border-solid border border-[#2E3438] w-fit rounded-[0.625rem]">
                      ...
                      <div className="flex absolute right-4 bottom-4 flex-wrap justify-end items-center gap-2 sm:gap-4">
                        ...
                        <div className="rounded-[9999px] pt-[0.2rem] px-[.75rem] pb-[0.2rem] sm:px-[1.2rem] sm:pb-[0.4rem]  bg-[#FFD98F] border-none">
                          <p className=" text-[#B88217] text-[0.6rem] sm:text-[0.8rem] cursor-pointer font-medium">
                            Adventure
                          </p>
                        </div>
                        <div className="rounded-[9999px] pt-[0.2rem] px-[.75rem] pb-[0.2rem] sm:px-[1.2rem] sm:pb-[0.4rem]  bg-[#D1FADF] border-none">
