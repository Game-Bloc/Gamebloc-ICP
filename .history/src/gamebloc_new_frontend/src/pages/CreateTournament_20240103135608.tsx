                ...
                {active === "first" && (
                  <div className="border rounded-[0.625rem] w-full lg:w-[50%] mt-8 border-solid border-[#2E3438]">
                    ...
                    <button
                      ...
                      className="pt-1 pb-[.15rem] justify-end  px-[.6rem] w-full lg:w-[15rem] sm:px-4 text-[.7rem] sm:text-base text-black justify-center mt-[0.7rem] sm:mt-[1.5rem] flex bg-primary-second rounded-md items-center cursor-pointer sm:py-3"
                    >
                      Next
                    </button>
                  </div>
