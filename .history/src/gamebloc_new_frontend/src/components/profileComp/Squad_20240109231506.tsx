    ...
    <div className="w-full flex justify-center mt-[3rem]">
      <div className="flex flex-col ">
        ...
        <div className=" flex justify-center  items-center mt-[3rem]">
          ...
          <button className="pt-1 pb-[.15rem] ml-4  px-[.6rem]  sm:px-4 text-[.7rem] sm:text-sm text-black justify-center  flex bg-primary-second rounded-lg items-center cursor-pointer sm:py-2">
