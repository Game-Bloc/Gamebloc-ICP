          ...
          >
            ...
            <Wrapper padding="1rem" display="flex" flexDirection="column">
              ...
              <Paragraph margin="1rem 0 0 0" smfontSize=".7rem">
                As a registered user, you have the power to create your own
                tournaments. Specify the game, tournament format, entry fees
                (for crowdfunded tournaments), and prize pool (for prepaid
                tournaments). Set the rules and guidelines, and watch as gamers
                from all over sign up for your event. Browse through the list of
                upcoming tournaments. Join your preferred tournament by paying
                the entry fee or confirming your participation. Get ready to
                compete and showcase your gaming skills. If you're a winner,
                your prizes will be awarded based on the tournament's rules.
                Receive your rewards and bask in the glory of your victory.
              </Paragraph>
            </Wrapper>
          </Container>
        </Container>
