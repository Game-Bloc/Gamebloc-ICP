...
import { canisterId, createActor } from "../src/declarations/kitchen"
import { ActorSubclass } from "@dfinity/agent"
import { _SERVICE } from "../src/declarations/kitchen/kitchen.did"
...
export const useAuthClient = (options = defaultOptions) => {
  ...
  const [whoamiActor, setWhoamiActor] = useState<ActorSubclass<_SERVICE>>(null)
  ...
  async function updateClient(client) {
    ...
    console.log(
      "Profile",
      actor.getSelf().then((res) => console.log("res", res)),
    )
  }
