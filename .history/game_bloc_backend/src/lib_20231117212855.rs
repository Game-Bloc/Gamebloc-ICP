...
#[query(name = "getSelfPrincipal")]
fn get_self_with_principal(principal:  Principal) -> UserProfile {
    // let id = ic_cdk::api::caller();
    PROFILE_STORE.with(|profile_store| {
        profile_store
            .borrow()
...
#[update]
fn create_profile(profile: UserProfile,) -> Principal {
...
#[update]
fn create_profile_with_principal(profile: UserProfile, principal_id: Principal) -> Principal {
