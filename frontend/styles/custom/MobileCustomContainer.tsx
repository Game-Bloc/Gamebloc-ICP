...
import { MobileCustomerContainerStyled } from "../../helper/MobileCustomContainerStyled";
 

export const MobileCustomContainer = styled(MobileCustomerContainerStyled)`
  ...
  grid-template-columns: ${(props) => props.gridColumn ? `${props.gridColumn}` : "unset"};
  ...
  border-radius: ${(props) => (props.borderRadius ? props.borderRadius : '0rem 0rem 0rem 0rem')};
  ...
  @media screen and (min-width: 1025px) {
    display: ${(props) => props.maxdisplay && `${props.maxdisplay}`};
  }
